...
@Component("sellStrategy4")
public class SellStrategyImpl4 implements SellStockStrategy {
	@Autowired
	...
	public Map<String, Object> getSellStrategyDecisions(String date, List<OwnedStock> availableStocks) {
		...
		for (StockTo stock : foundedStocks) {
			Double avgOfStock = stockService.countStocksAvgToDateAndDaysAmount(stock.getName(), stock.getDate(),25);
