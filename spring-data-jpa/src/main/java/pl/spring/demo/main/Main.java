...
public class Main {
	...
	public static void main(String[] args) {
		...
		System.out.println("\n*kupna"
				...
				+ "\n4 - sprzedawanie 75% posiadanych akcji gdzie cena akcji jest wieksza niz srednia cena akcji z 25 notowanych dni (nacisnij Enter)");
		scanner.nextLine();
		...
		do {
			System.out.println("Wyswietlac dzienne akcje?");
